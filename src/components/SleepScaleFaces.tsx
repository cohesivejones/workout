...
export const SleepFace1: React.FC<SleepFaceProps> = ({ size = 40, className }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
    <circle cx="50" cy="50" r="45" fill="#f44336" stroke="#d32f2f" strokeWidth="2" />
    {/* Tired eyes (half closed) */}
    <path d="M30 40 Q35 45 40 40" stroke="#fff" strokeWidth="3" fill="none" />
    <path d="M60 40 Q65 45 70 40" stroke="#fff" strokeWidth="3" fill="none" />
    {/* Frowning mouth */}
    <path d="M30 70 Q50 60 70 70" stroke="#fff" strokeWidth="4" fill="none" />
    {/* Dark circles under eyes */}
    <path d="M25 45 Q35 50 45 45" stroke="#d32f2f" strokeWidth="2" fill="none" opacity="0.5" />
    <path d="M55 45 Q65 50 75 45" stroke="#d32f2f" strokeWidth="2" fill="none" opacity="0.5" />
  </svg>
);

// Sleep level 2: Poor - Tired face
export const SleepFace2: React.FC<SleepFaceProps> = ({ size = 40, className }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
    <circle cx="50" cy="50" r="45" fill="#ff9800" stroke="#f57c00" strokeWidth="2" />
    {/* Slightly tired eyes */}
    <path d="M30 40 Q35 43 40 40" stroke="#fff" strokeWidth="3" fill="none" />
    <path d="M60 40 Q65 43 70 40" stroke="#fff" strokeWidth="3" fill="none" />
    {/* Slightly frowning mouth */}
    <path d="M30 65 Q50 60 70 65" stroke="#fff" strokeWidth="4" fill="none" />
    {/* Light circles under eyes */}
    <path d="M30 45 Q35 48 40 45" stroke="#f57c00" strokeWidth="2" fill="none" opacity="0.3" />
    <path d="M60 45 Q65 48 70 45" stroke="#f57c00" strokeWidth="2" fill="none" opacity="0.3" />
  </svg>
);

// Sleep level 3: Fair - Neutral face
export const SleepFace3: React.FC<SleepFaceProps> = ({ size = 40, className }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
...
export const SleepFace4: React.FC<SleepFaceProps> = ({ size = 40, className }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
...
export const SleepFace5: React.FC<SleepFaceProps> = ({ size = 40, className }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
