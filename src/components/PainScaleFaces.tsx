...
export const PainFace0: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
...
export const PainFace1: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
...
export const PainFace2: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
...
export const PainFace3: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
...
export const PainFace4: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
...
export const PainFace5: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
...
export const PainFace6: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
...
export const PainFace7: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
    ...
    {/* Left teardrop */}
    <path
      d="M35 45 Q33 50 35 55 Q37 50 35 45"
      fill="#fff"
      stroke="#fff"
      strokeWidth="1"
    />
    {/* Right teardrop */}
    <path
      d="M65 45 Q63 50 65 55 Q67 50 65 45"
      fill="#fff"
      stroke="#fff"
      strokeWidth="1"
    />
...
export const PainFace8: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
    ...
    <path
      d="M35 45 Q32 52 35 60 Q38 52 35 45"
      fill="#fff"
      stroke="#fff"
      strokeWidth="1"
    />
    ...
    <path
      d="M65 45 Q62 52 65 60 Q68 52 65 45"
      fill="#fff"
      stroke="#fff"
      strokeWidth="1"
    />
...
export const PainFace9: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
    ...
    />
    <path
      d="M30 50 Q27 60 30 70 Q33 60 30 50"
      fill="#fff"
      stroke="#fff"
      strokeWidth="1"
    />
    ...
    />
    <path
      d="M70 50 Q67 60 70 70 Q73 60 70 50"
      fill="#fff"
      stroke="#fff"
      strokeWidth="1"
    />
...
export const PainFace10: React.FC<PainFaceProps> = ({
  size = 40,
  className,
}) => (
  <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
    ...
    />
    <path
      d="M25 45 Q22 60 25 75 Q28 60 25 45"
      fill="#fff"
      stroke="#fff"
      strokeWidth="1"
    />
    ...
    />
    <path
      d="M75 45 Q72 60 75 75 Q78 60 75 45"
      fill="#fff"
      stroke="#fff"
      strokeWidth="1"
    />
