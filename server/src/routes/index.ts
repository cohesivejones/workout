...
import workoutCoach from './workout-coach.routes';
...
import nutritionLabelScan from './nutrition-label-scan.routes';
import nutritionMonthly from './nutrition-monthly.routes';
...
router.use('/workout-coach', workoutCoach);
...
router.use('/nutrition-label', nutritionLabelScan);
router.use('/nutrition', nutritionMonthly);
